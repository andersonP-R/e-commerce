...
const ProductAdminPage: FC<Props> = ({ product }) => {
  ...
  const onChangeSize = (size: string) => {
    // obtenemos los values del arreglo de sizes
    const currentSizes = getValues("sizes");

    // eliminamos el size que nos llega por param
    ...
    // finalmente actualizamos el arreglo de validSizes con los currentSizes
